package com.siri.user.ui.detail.section
...
import com.siri.user.ui.detail.DetailViewModel
...
fun DetailContent(
    ...
    Box(
        ...
        Row(horizontalArrangement = Arrangement.SpaceEvenly) {
            viewModel.productUiStateDbProduct.collectAsState(initial = ProductUiState.Loading).value.let { uiState ->
                when (uiState) {
